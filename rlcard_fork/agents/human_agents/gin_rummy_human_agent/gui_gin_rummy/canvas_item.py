...
if TYPE_CHECKING:
    from rlcard_fork.agents.gin_rummy_human_agent.gui_gin_rummy.game_canvas import GameCanvas
    from rlcard_fork.agents.gin_rummy_human_agent.gui_cards.card_image import CardImage
