...
class DoudizhuEnv(Env):
    ...
    def __init__(self, config):
        from rlcard_fork.games.doudizhu.utils import ACTION_2_ID, ID_2_ACTION
        from rlcard_fork.games.doudizhu.utils import cards2str, cards2str_with_suit
        from rlcard_fork.games.doudizhu import Game
